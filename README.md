...
# 二、Excel模板定义
## 1. Excel模板定义说明
![](https://github.com/ai-coders/tcom-poi/blob/master/poi-doc/images/Excel_Tpl.jpg)
...
|F14未使用 |空值|		|该行无参数配置，写上这一条完全是为Readme文件排版更好看而已
...
## 2. 生成数据定义的配置文件
        ...
        工具生成的配置文件实例：tcom-poi\poi-example\data\Template\tbl_tpl.xml
### 配置参数设定
![](https://github.com/ai-coders/tcom-poi/blob/master/poi-doc/images/TplDefine2Xml.jpg)
...
- 不导入的Sheet，数据导入时不会导入的Sheet，有多个Sheet时用逗号分隔。<br>
